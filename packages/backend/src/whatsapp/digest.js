 ...
 * channel via wacli. Jobs are picked at random from the active German jobs
 * (remote jobs excluded), weighting jobs posted in the last 30 days 3x.
 * Sent jobs are tracked in the `whatsappSentJobs` collection so nothing
 * repeats until the pool is cycled.
 *
