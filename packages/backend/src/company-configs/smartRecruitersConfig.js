...
export const smartRecruitersConfig = {
    ...
    companyIdentifiers: [
        ...
        'Eurofins',  // Added via discovery — 185 DE / 2541 total
        'HRDpt',  // Added via discovery — 183 DE / 183 total
        'CheckPointSoftwareTechnologies2',  // Added via discovery — 16 DE / 403 total
        'ZooplusSE',  // Added via discovery — 10 DE / 28 total
        'Jobpal1',  // Added via discovery — 4 DE / 4 total
        'Kayzen1',  // Added via discovery — 2 DE / 5 total
        '3FacesRecruitmentLimited',  // Added via discovery — 1 DE / 16 total
        'Cielo2',  // Added via discovery — 1 DE / 71 total
        // --- DISCOVERY 2026-09-15 (web search + API verified: >=1 job in Germany) ---
        'RVAllgemeineVersicherungenAG',  // Added via discovery — 1314 DE / 1315 total
        'ATUAuto-Teile-Unger',  // Added via discovery — 860 DE / 860 total
        'Bertelsmann-Jobs',  // Added via discovery — 467 DE / 969 total
        'BarmeniaGothaerAG',  // Added via discovery — 386 DE / 386 total
        'vitosggmbh',  // Added via discovery — 292 DE / 292 total
        'ramboll3',  // Added via discovery — 289 DE / 1182 total
        'StrerSECoKGaAStrerGruppe',  // Added via discovery — 254 DE / 254 total
        'SopraSteria1',  // Added via discovery — 246 DE / 1975 total
        'tipico',  // Added via discovery — 142 DE / 168 total
        'RobertBoschKrankenhausGmbH',  // Added via discovery — 135 DE / 135 total
        'ThaliaBcherGmbH1',  // Added via discovery — 129 DE / 147 total
        'RheinGroup',  // Added via discovery — 118 DE / 118 total
        'Wiegel',  // Added via discovery — 93 DE / 94 total
        'SMCP',  // Added via discovery — 93 DE / 563 total
        'ContinentalGroupSectorContiTech',  // Added via discovery — 92 DE / 478 total
        'RHG',  // Added via discovery — 76 DE / 982 total
        'sgs',  // Added via discovery — 75 DE / 4464 total
        'SikaAG',  // Added via discovery — 75 DE / 715 total
        'Vattenfall',  // Added via discovery — 67 DE / 273 total
        'turnertownsend',  // Added via discovery — 67 DE / 3103 total
        'aecom2',  // Added via discovery — 63 DE / 5287 total
        'OTTOFUCHSKG',  // Added via discovery — 62 DE / 62 total
        'RedBull',  // Added via discovery — 51 DE / 1214 total
        'intuitive',  // Added via discovery — 46 DE / 681 total
        'renesaselectronics',  // Added via discovery — 43 DE / 943 total
        'KOSTALGroup',  // Added via discovery — 43 DE / 122 total
        'FischerGroup',  // Added via discovery — 42 DE / 47 total
        'kanadeviainova',  // Added via discovery — 40 DE / 201 total
        'NETZSCHGroup',  // Added via discovery — 38 DE / 56 total
        'nagarro1',  // Added via discovery — 36 DE / 893 total
        'SedusGruppe',  // Added via discovery — 35 DE / 36 total
        'miltenyibiotec1',  // Added via discovery — 35 DE / 42 total
        'SYNTEGON',  // Added via discovery — 35 DE / 118 total
        'Projekt0708GmbH',  // Added via discovery — 35 DE / 35 total
        'wabtec',  // Added via discovery — 35 DE / 730 total
        'Kronospan',  // Added via discovery — 34 DE / 339 total
        'citrusgloballtd',  // Added via discovery — 34 DE / 120 total
        'fusionconsulting',  // Added via discovery — 33 DE / 103 total
        'CliffordChance',  // Added via discovery — 30 DE / 165 total
        'WernerMertzGmbH',  // Added via discovery — 29 DE / 39 total
        'atialtd',  // Added via discovery — 29 DE / 868 total
        'implementconsultinggroup',  // Added via discovery — 29 DE / 60 total
        'ATLAS4',  // Added via discovery — 27 DE / 27 total
        'AlpadiaLanguageSchoolsSA',  // Added via discovery — 27 DE / 67 total
        'berlinerverkehrsbetriebebvg1',  // Added via discovery — 25 DE / 25 total
        'LEONI1',  // Added via discovery — 24 DE / 301 total
        'rhaegalsandbox',  // Added via discovery — 24 DE / 558 total
        'Tieto2',  // Added via discovery — 23 DE / 366 total
        'rexel1',  // Added via discovery — 23 DE / 754 total
        'GRAUGmbHCoKG',  // Added via discovery — 21 DE / 21 total
        'gesellschaftfrgesundheitundpdagogikmbh',  // Added via discovery — 21 DE / 21 total
        'uatalents',  // Added via discovery — 21 DE / 30 total
        'Accor',  // Added via discovery — 20 DE / 565 total
        'SBBCargoDeutschlandGmbH',  // Added via discovery — 19 DE / 19 total
        'smithsgroup2',  // Added via discovery — 18 DE / 515 total
        'ingrop',  // Added via discovery — 18 DE / 246 total
        'VeoliaEnvironnementSA',  // Added via discovery — 16 DE / 2936 total
        'sobi',  // Added via discovery — 16 DE / 109 total
        'synava',  // Added via discovery — 15 DE / 15 total
        'radiuslimited',  // Added via discovery — 14 DE / 153 total
        'nielseniq',  // Added via discovery — 14 DE / 384 total
        'AVANCOGmbH',  // Added via discovery — 14 DE / 14 total
        'angloamericandebeersgroup',  // Added via discovery — 13 DE / 113 total
        'statkraft1',  // Added via discovery — 13 DE / 105 total
        'Aviko',  // Added via discovery — 13 DE / 53 total
        'TheAdaptavistGroup',  // Added via discovery — 13 DE / 29 total
        'MontamoGmbH',  // Added via discovery — 12 DE / 12 total
        'TOPdesk',  // Added via discovery — 11 DE / 52 total
        'experian',  // Added via discovery — 11 DE / 433 total
        'averydennison',  // Added via discovery — 11 DE / 454 total
        'ElatecGmbH',  // Added via discovery — 10 DE / 10 total
        'repagroup',  // Added via discovery — 10 DE / 16 total
        'rocketinternet',  // Added via discovery — 10 DE / 17 total
        'BexTechnologiesGmbH',  // Added via discovery — 10 DE / 10 total
        'somfygroup',  // Added via discovery — 10 DE / 67 total
        'adeebaeservicespvtltd',  // Added via discovery — 10 DE / 23806 total
        'LACROIX1',  // Added via discovery — 10 DE / 46 total
        'joveosandbox',  // Added via discovery — 9 DE / 63 total
        'systabuildsoftwaregroup',  // Added via discovery — 9 DE / 14 total
        'McArthurGlenUKLtd1',  // Added via discovery — 9 DE / 22 total
        'jobsforhumanity',  // Added via discovery — 8 DE / 3122 total
        'crb',  // Added via discovery — 8 DE / 236 total
        'relaischateaux',  // Added via discovery — 8 DE / 699 total
        'rotork1',  // Added via discovery — 8 DE / 139 total
        'louisdreyfuscompany',  // Added via discovery — 8 DE / 446 total
        'AudemarsPiguet',  // Added via discovery — 8 DE / 96 total
        'KingAndMoffatt',  // Added via discovery — 8 DE / 21 total
        'SyngentaGroup',  // Added via discovery — 8 DE / 495 total
        'FinanzennetGmbH',  // Added via discovery — 8 DE / 8 total
        'CipMarketingGmbH1',  // Added via discovery — 8 DE / 17 total
        'SeniorPlc1',  // Added via discovery — 8 DE / 172 total
        'stowgroup',  // Added via discovery — 7 DE / 151 total
        'Akirolabs',  // Added via discovery — 7 DE / 7 total
        'BlackbirdCollective',  // Added via discovery — 7 DE / 7 total
        'VolkerWesselsTelecomDeutschlandGmbH',  // Added via discovery — 7 DE / 7 total
        'ogegmbh1',  // Added via discovery — 7 DE / 7 total
        'qima',  // Added via discovery — 6 DE / 725 total
        'mattelinc',  // Added via discovery — 6 DE / 442 total
        'embassysporthandelgmbh',  // Added via discovery — 6 DE / 6 total
        'DENSOINTERNATIONALEUROPE',  // Added via discovery — 6 DE / 16 total
        'boskalis',  // Added via discovery — 5 DE / 107 total
        'Financeactive',  // Added via discovery — 5 DE / 14 total
        'psicro',  // Added via discovery — 5 DE / 214 total
        'sinergiach',  // Added via discovery — 5 DE / 10 total
        'COMPOEXPERTGmbH',  // Added via discovery — 5 DE / 5 total
        'canva',  // Added via discovery — 5 DE / 250 total
        'blackapplesolutionsltd1',  // Added via discovery — 4 DE / 47 total
        'Salomon',  // Added via discovery — 4 DE / 77 total
        'westerndigital',  // Added via discovery — 4 DE / 334 total
        'CapitolInternationalServicesLtd',  // Added via discovery — 4 DE / 11 total
        'Vosker',  // Added via discovery — 4 DE / 27 total
        'xppower2',  // Added via discovery — 4 DE / 88 total
        'TeleconnectGmbH',  // Added via discovery — 4 DE / 4 total
        'Primark',  // Added via discovery — 4 DE / 866 total
        'KoTAGmbH',  // Added via discovery — 4 DE / 4 total
        'PremiumEntertainmentGmbH',  // Added via discovery — 4 DE / 4 total
        'hashtagtalent',  // Added via discovery — 3 DE / 29 total
        'HoistGroup',  // Added via discovery — 3 DE / 13 total
        'sqli1',  // Added via discovery — 3 DE / 239 total
        'sportradar',  // Added via discovery — 3 DE / 75 total
        'bectondickinson2',  // Added via discovery — 3 DE / 117 total
        'ACT-ON',  // Added via discovery — 3 DE / 37 total
        'BSInternational',  // Added via discovery — 3 DE / 63 total
        'Autodoc3',  // Added via discovery — 3 DE / 44 total
        'IPsoft',  // Added via discovery — 3 DE / 30 total
        'Lesaffre',  // Added via discovery — 3 DE / 184 total
        'Quadient1',  // Added via discovery — 3 DE / 69 total
        'gcore',  // Added via discovery — 2 DE / 16 total
        'dev2',  // Added via discovery — 2 DE / 4728 total
        'careerteam',  // Added via discovery — 2 DE / 2 total
        'AustroHolding',  // Added via discovery — 2 DE / 32 total
        'sigmasoftware2',  // Added via discovery — 2 DE / 110 total
        'nbcuniversal3',  // Added via discovery — 2 DE / 383 total
        'ChiquitaBrandsInternationalSrl',  // Added via discovery — 2 DE / 7 total
        'GIANTSSoftwareGmbH',  // Added via discovery — 2 DE / 4 total
        'ODIONGmbH',  // Added via discovery — 2 DE / 2 total
        'VariosystemsAG',  // Added via discovery — 2 DE / 52 total
        'Wise',  // Added via discovery — 2 DE / 420 total
        'Cosun2',  // Added via discovery — 2 DE / 57 total
        'InfinityQuest',  // Added via discovery — 2 DE / 10 total
        'JobTeaser',  // Added via discovery — 2 DE / 8 total
        'WegnerExpressGmbH',  // Added via discovery — 2 DE / 2 total
        'LegalAndGeneral',  // Added via discovery — 2 DE / 98 total
        'senndergmbh',  // Added via discovery — 2 DE / 2 total
        'liftedanupworkcompany',  // Added via discovery — 2 DE / 319 total
        'deepspin',  // Added via discovery — 1 DE / 1 total
        'digitalvirgo',  // Added via discovery — 1 DE / 48 total
        'allegisglobalsolutions',  // Added via discovery — 1 DE / 128 total
        'evolution',  // Added via discovery — 1 DE / 298 total
        'cybervadis',  // Added via discovery — 1 DE / 9 total
        'jsheldllc',  // Added via discovery — 1 DE / 103 total
        'internations',  // Added via discovery — 1 DE / 1 total
        'metgroup',  // Added via discovery — 1 DE / 67 total
        'miratech1',  // Added via discovery — 1 DE / 254 total
        'qadinc',  // Added via discovery — 1 DE / 53 total
        'natuviongmbh',  // Added via discovery — 1 DE / 1 total
        'mountfitchetgroup',  // Added via discovery — 1 DE / 76 total
        'prosidianconsulting',  // Added via discovery — 1 DE / 4021 total
        'revalize',  // Added via discovery — 1 DE / 13 total
        'sia',  // Added via discovery — 1 DE / 586 total
        'repriskag',  // Added via discovery — 1 DE / 3 total
        'iad',  // Added via discovery — 1 DE / 13 total
        'speexx',  // Added via discovery — 1 DE / 1 total
        'versant3',  // Added via discovery — 1 DE / 162 total
        'ABL2',  // Added via discovery — 1 DE / 10 total
        'Averna1',  // Added via discovery — 1 DE / 18 total
        'Ergomed',  // Added via discovery — 1 DE / 117 total
        'stackone',  // Added via discovery — 1 DE / 29 total
        'DecipheraPharmaceuticals1',  // Added via discovery — 1 DE / 19 total
        'Nemera',  // Added via discovery — 1 DE / 99 total
        'GenerixGroup',  // Added via discovery — 1 DE / 21 total
        'TessenderloGroup',  // Added via discovery — 1 DE / 107 total
        'Unit44',  // Added via discovery — 1 DE / 45 total
        '10xValuePartnersGmbH',  // Added via discovery — 1 DE / 5 total
        'CoDominicMultererGmbH',  // Added via discovery — 1 DE / 1 total
        'BaluLogistikUGhaftungsbeschrankt',  // Added via discovery — 1 DE / 1 total
        'EmsExpressGmbH',  // Added via discovery — 1 DE / 1 total
        'Heitman',  // Added via discovery — 1 DE / 8 total
        'EtihadAirways5',  // Added via discovery — 1 DE / 119 total
        'InfoBeans',  // Added via discovery — 1 DE / 6 total
        'HermesBorderGuruGmbH',  // Added via discovery — 1 DE / 1 total
        'Hybeio',  // Added via discovery — 1 DE / 1 total
        'JULIANMATTHEWSGmbH',  // Added via discovery — 1 DE / 1 total
        'Kadmos',  // Added via discovery — 1 DE / 1 total
        'ManimaLogistikGmbH',  // Added via discovery — 1 DE / 1 total
        'MigrateCorp',  // Added via discovery — 1 DE / 42 total
        'RSConsultants',  // Added via discovery — 1 DE / 8 total
        'Scalian',  // Added via discovery — 1 DE / 671 total
        'malengo',  // Added via discovery — 1 DE / 1 total
        'SeaToSummitPtyLtd',  // Added via discovery — 1 DE / 6 total
        'SpeedUUpGmbH',  // Added via discovery — 1 DE / 1 total
        'fantium',  // Added via discovery — 1 DE / 1 total
        'ulbrichsteel',  // Added via discovery — 1 DE / 15 total
        'heycater',  // Added via discovery — 1 DE / 2 total
        'ipsoftinc1',  // Added via discovery — 1 DE / 45 total
        'salesianermiettex',  // Added via discovery — 1 DE / 40 total
        'pixibo',  // Added via discovery — 1 DE / 7 total
        // --- DISCOVERY 2026-09-15 (web search + API verified: >=1 job in Germany) ---
        'McMakler1',  // Added via discovery — 21 DE / 23 total
        'PatronusGroup1',  // Added via discovery — 1 DE / 1 total
        'HyperganicGroup',  // Added via discovery — 1 DE / 1 total
        'Physikit',  // Added via discovery — 1 DE / 1 total
        // --- DISCOVERY 2026-09-15 (web search + API verified: >=1 job in Germany) ---
        'GMSServices',  // Added via discovery — 7 DE / 30 total
        'caci',  // Added via discovery — 3 DE / 14 total
        'AmvaDev1',  // Added via discovery — 1 DE / 2 total
        'Jobbatical',  // Added via discovery — 1 DE / 2 total
        // --- DISCOVERY 2026-09-15 (web search + API verified: >=1 job in Germany) ---
        'businesstodaynetworkgmbh',  // Added via discovery — 10 DE / 10 total
        'b2bleadfactorygmbh',  // Added via discovery — 4 DE / 4 total
        'bdelectronics',  // Added via discovery — 4 DE / 13 total
        'advancedcomputersystemsacs-dgmbh',  // Added via discovery — 1 DE / 1 total
        'astorfilmtheaterbraunschweig',  // Added via discovery — 1 DE / 1 total
        'betriebsarztserviceholdinggmbh',  // Added via discovery — 1 DE / 1 total
],
